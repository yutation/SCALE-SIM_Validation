"""
Full pipeline for 2D operations: Train model -> Profile new shapes -> Compare predictions vs actual.
...
TRAINING_CSV = "./model/add_dataset_2d.csv"
OUTPUT_DIR = "./pipeline_results_2d"
N_TEST_SHAPES = 100
