...
It can handle duplicates and provides various merge options.

Usage:
    python merge_csv_files.py file1.csv file2.csv file3.csv -o output.csv
...
def merge_csv_files(input_files, output_file, merge_strategy='concat', key_column=None, 
                   drop_duplicates=True, sort_by=None, ascending=True):
    """
...
Examples:
  ...
  python merge_csv_files.py *.csv -o output.csv --sort-by kernel_name --no-drop-duplicates
        """
    )
